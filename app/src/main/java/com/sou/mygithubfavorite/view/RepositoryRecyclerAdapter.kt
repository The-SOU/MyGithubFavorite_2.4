package com.sou.mygithubfavorite.view
...
import com.sou.mygithubfavorite.databinding.ViewholderRepositoryItemBinding
import com.sou.mygithubfavorite.extensions.loadCenterInside
...
class RepositoryRecyclerAdapter :
    ...
    inner class RepositoryItemViewHolder(
        ...
        fun bindData(data: GithubRepoEntity) = with(binding) {
            ...
            subTextView.text = data.description
