...
import com.sou.mygithubfavorite.databinding.ActivitySignInBinding
import com.sou.mygithubfavorite.utillity.AuthTokenProvider
    ...
    private suspend fun getAccessToken(code: String) = withContext(Dispatchers.IO) {
        ...
        if (response.isSuccessful) {
            ...
            if (accessToken.isNotEmpty()) {
                ...
                Toast.makeText(this@SingInActivity, "accessToken이 존재하지 않습니다.", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
